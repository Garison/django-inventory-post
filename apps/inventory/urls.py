...
urlpatterns = patterns('inventory.views',
    ...
    url(r'^template/(?P<object_id>\d+)/$', generic_detail, dict(form_class=ItemTemplateForm_view, queryset=ItemTemplate.objects.all(), extra_context={'sidebar_subtemplates':['generic_photos_subtemplate.html']}), 'template_view'),
