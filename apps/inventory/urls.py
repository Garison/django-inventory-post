...
template_record_links = [
        { 'text' : _(u'Edit'), 'view' : 'template_update', 'icon' : MEDIA_URL+'images/accessories-text-editor.png' },
        { 'text' : _(u'Delete'), 'view' : 'template_delete', 'icon' : MEDIA_URL+'images/emblem-unreadable.png' },
        { 'text' : _(u'Photos'), 'view' : 'template_photos', 'icon': MEDIA_URL + 'images/camera-photo.png' },
        { 'text' : _(u'Items that use this template'), 'view' : 'template_items_list', 'icon': MEDIA_URL + 'images/folder-saved-search.png' },
        { 'text' : _(u'Assign/Remove items'), 'view' : 'template_assign_supply', 'icon': MEDIA_URL + 'images/edit-redo.png'},
    ]
    
item_record_links = [
        { 'text' : _(u'Edit'), 'view' : 'item_update', 'icon' : MEDIA_URL+'images/accessories-text-editor.png'},
        { 'text' : _(u'Delete'), 'view' : 'item_delete', 'icon' : MEDIA_URL+'images/emblem-unreadable.png'},
        { 'text' : _(u'Photos'), 'view' : 'item_photos', 'icon': MEDIA_URL + 'images/camera-photo.png' },
        { 'text' : _(u'Assign/Remove'), 'view' : 'item_assign_person', 'icon': MEDIA_URL + 'images/item-plus-user.png' },
        { 'text' : _(u'Decomisar'), 'view' : 'item_retire', 'icon': MEDIA_URL + 'images/user-trash.png' },
        { 'text' : _(u'Repair'), 'view' : 'item_sendtorepairs', 'icon': MEDIA_URL + 'images/broken-computer.png' },
        { 'text' : _(u'Template'), 'view' : 'template_view', 'icon' : MEDIA_URL+'images/font-x-generic.png', 'args': 'object.item_template.id'},
    ]
...
person_links = [
        { 'text' : _(u'Edit'), 'view' : 'person_update', 'icon' : MEDIA_URL+'images/accessories-text-editor.png'},
        { 'text' : _(u'Delete'), 'view' : 'person_delete', 'icon' : MEDIA_URL+'images/emblem-unreadable.png'},
        { 'text' : _(u'Edit photos'), 'view' : 'person_photos', 'icon': MEDIA_URL + 'images/camera-photo.png' },
        { 'text' : _(u'Assign/Remove item'), 'view' : 'person_assign_item', 'icon': MEDIA_URL + 'images/item-plus-user.png'},
     ]
...
user_links = [
        { 'text' : 	_(u'Edit'), 'view': 'user_update', 'icon' : MEDIA_URL+'images/accessories-text-editor.png' },
        { 'text' : 	_(u'Delete'), 'view' : 'user_delete', 'icon' : MEDIA_URL+'images/emblem-unreadable.png'},
